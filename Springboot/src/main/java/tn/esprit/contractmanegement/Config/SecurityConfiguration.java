...
import tn.esprit.contractmanegement.Exception.CustomAccessDeniedHandler;
import tn.esprit.contractmanegement.Exception.CustomAuthenticationEntryPoint;
        ...
        httpSecurity
                ...
                .authorizeHttpRequests(req ->
                        req.requestMatchers( "/user/Register","/user/auth","/user/ConfirmAccount/**","/user/forgot-password/**",
                                ...
                                .requestMatchers("/api/admin/sinisters/**").permitAll()
